 ...
 *
 */
public class MonitoringAppMetricSource implements MetricSource {
	 ...
	 * 
	 */
	public MonitoringAppMetricSource() {}
	...
	public List<String> scrap() {
		...
		RestContext context = new RestContext(null, uri) ;
		try {
	...
	private List<String> getMetrics(RestContext context)
			throws Exception {
		try {
