...
import io.monitoring.client.Collector;
import io.monitoring.client.CollectorRegistry;
...
public class MonitoringGateway {
   ...
   */
  public MonitoringGateway(String address) {
   ...
   */
  public MonitoringGateway(URL serverBaseURL) {
